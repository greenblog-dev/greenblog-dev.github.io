...
{% comment %} 🔥 PENTING: Cek dulu apakah kategori agenda ada {% endcomment %}
{% if site.categories.agenda and site.categories.agenda.size > 0 %}
  {% assign agendas = site.categories.agenda | sort: 'date' | reverse %}
...
{% else %}
  <!-- 🔥 FALLBACK: Jika belum ada post agenda -->
  <p class="empty-state">
